...
const Hero = () => {
  return (
    <section className="hero_section w-10/12 m-auto mt-20 flex flex-col justify-center items-center text-center">
      ...
      <a className="bg-[#FFCE0C] text-slate-100 rounded px-6 py-2" href="#">
        Book Your Tour
      </a>
    </section>
  );
